...
export class ModalService {
  ...
  showConfirmationModal(customModalOptions?, customModalDefaults?) {
    if (!customModalDefaults) {
      customModalDefaults = {};
    }
    if (!customModalOptions) {
    ...
    customModalDefaults.backdrop = 'static';
    return this.open(customModalDefaults, customModalOptions, this.confirmationModalOptions, this.confirmationModalDefaults);
  }

  open(customModalDefaults, customModalOptions, defaultModalOptions, modalDefaults) {
    const tempModalDefaults = {};
    const tempModalOptions = { class: 'fixed-top' };
